...
// 1、获取初始化的文章、作者、相关推荐的信息（登录后）
export const getArticleDetail = (params: any): Promise<any> => {
    return $get('/article/detail', params);
};

//1-1、获取初始化的文章、作者、相关推荐的信息（游客）
export const getTouristArticleDetail = (params: any): Promise<any> => {
    return $get('/article/tourists/detail', params);
};
...
//3、获取初始化作者的信息(游客)
export const getTouristAuthorDetail = (params: any): Promise<any> => {
    return $get('/tourist/init_userinfo', params);
};
//4、点赞
